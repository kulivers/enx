...
namespace enc
{
    internal class Program
    {
        ...
        private static readonly Lazy<Dictionary<int, string>> EncodingDisplayNames = new Lazy<Dictionary<int, string>>(() => new Dictionary<int, string>()
        {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                var displayName = e.DisplayName.StartsWith("Globalization") ? EncodingDisplayNames.Value[e.CodePage] : e.DisplayName;
